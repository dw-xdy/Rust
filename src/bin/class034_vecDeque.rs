...
//
// fn main() {
//     // use VecDeque, we just change point. don't have any about move vec operate.
//     // that's why VecDeque and Vector is same code operate, VecDeque is faster.
